...
### AI Integrations
- **Chat**: OpenAI-compatible chat completions via Replit AI Integrations (`server/replit_integrations/chat/`)
- **Image Generation**: GPT-image-1 model for image creation (`server/replit_integrations/image/`)
- **Batch Processing**: Rate-limited batch utilities for bulk AI operations (`server/replit_integrations/batch/`)
...
### AI Services
- **Replit AI Integrations**: OpenAI-compatible API for chat and image generation
