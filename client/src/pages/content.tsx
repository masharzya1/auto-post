...
export default function ContentPage() {
  ...
  const generateMutation = useMutation({
    mutationFn: async (type: string) => {
      ...
      // In a real app, this would be an API call to a backend that uses the API keys
      // For this MVP, we simulate the "AI" using the selected niche and model
      const data = type === "text" 
        ? { 
            text: `[${model}] AI Generated Caption for ${niche}: This is a high-quality ${niche} post generated using ${model}.`, 
