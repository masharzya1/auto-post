...
import { Loader2, Plus, FileText, Image as ImageIcon, Video, Eye, Send } from "lucide-react";
        ...
        {content?.map((item) => (
          <Card key={item.id} className="overflow-hidden hover-elevate">
            ...
            <CardContent className="p-4 pt-0">
              <div className="bg-muted/30 rounded-md p-3 mb-3 aspect-video flex items-center justify-center text-xs text-muted-foreground border">
                {item.type === "image" ? "AI Image Preview" : "Content Text Snippet"}
              </div>
              <div className="flex gap-2">
