  ...
  const generateMutation = useMutation({
    mutationFn: async (type: string) => {
      ...
      if (type === "text") {
        ...
        // Direct AI call for image (DALL-E)
        if (!model.includes("gpt")) throw new Error("Only GPT models support image generation currently.");
        const openai = new OpenAI({ apiKey, dangerouslyAllowBrowser: true });
        ...
        data = { url: imageUrl, prompt: `${niche} themed artwork generated by ${model}` };
      }
