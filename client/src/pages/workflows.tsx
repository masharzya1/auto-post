...
export default function WorkflowsPage() {
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      {/* Advanced Industry Level Dashboard Section */}
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="bg-blue-500/5 border-blue-500/20">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Performance this week</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {workflows?.map((workflow) => (
          <Card key={workflow.id} className={workflow.enabled ? "hover-elevate" : "opacity-60"}>
            ...
            <CardContent className="space-y-4">
              <div className="p-3 rounded-lg bg-muted/50 border border-dashed">
                ...
                {editingId === workflow.id ? (
                  ...
                  >
                    <code className="text-xs font-mono text-primary">{workflow.cronSchedule}</code>
